...
@constraint(primal, constraint3,  2*x1  -3*x2 + 4*x3 - x0  >= 0)
@constraint(primal, constraint4,  -3*x1 + 4*x2  -5*x3 - x0  >= 0)

@constraint(primal, constraint5, x1 + x2 + x3  == 1)
...
@constraint(dual, constraint1, -2*y1 + 3*y2 + 2*y3 - 3*y4 - y0 <= 0)
@constraint(dual, constraint2, 3*y1  -4*y2 - 3*y3 + 4*y4 - y0 <= 0)
@constraint(dual, constraint3, -4*y1 + 5*y2 + 4*y3 - 5*y4 - y0 <= 0)

@constraint(dual, constraint4, y1 + y2 + y3 + y4  == 1)
JuMP.optimize!(dual)
print(dual)
